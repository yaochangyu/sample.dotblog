...
## git commit 時機
- 新增功能：當你新增了一個功能或改進現有功能時。
- 修復錯誤：當你修復了一個錯誤或問題時
- 優化性能：當你優化了程式碼的性能或效率時。
- 重構程式碼：當你重構了程式碼以提高可讀性或維護性時。
- 更新文件：當你更新了相關的文件或說明文件時。
- 添加測試：當你添加了新的測試或改進了現有的測試時。
- 其他：當你進行了其他類型的更改，但不屬於上述類別時，可以使用其他適當的類型（例如：chore、refactor、docs 等）。
