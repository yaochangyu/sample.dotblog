...
{
    private readonly string _vaultAddress = "http://127.0.0.1:8200";
    private readonly string _rootToken = "hvs.KcMWurPzkMwNeOk3c28a6Ceq";
    ...
    {
        // 設定環境變數
        Environment.SetEnvironmentVariable("VAULT_ADDR", _vaultAddress);
