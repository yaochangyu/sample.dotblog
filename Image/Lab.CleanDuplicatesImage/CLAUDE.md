...
**加分項**：
- **子目錄層級加分**（僅適用於主相簿）
  - 在 `DefaultMoveTargetBasePath` 下每個子目錄層級 **+1 分**
  - 計算方式：計算主相簿路徑之後的路徑分隔符號數量
  - 範例：
    - `C:\Users\clove\OneDrive\圖片\照片.jpg` → 0 層 → +0 分
    - `C:\Users\clove\OneDrive\圖片\2024\照片.jpg` → 1 層 → +1 分
    - `C:\Users\clove\OneDrive\圖片\2024\01\照片.jpg` → 2 層 → +2 分
...
| 檔案路徑 | 基礎分 | 深度加分 | 檔名減分 | 最終分數 | 說明 |
|---------|--------|---------|---------|---------|------|
| `D:\安茹蕾烘焙工作\食譜.jpg` | 100 | 0 | 0 | **100** | 工作資料夾，最高優先權 |
| `C:\Users\clove\OneDrive\圖片\2024\01\生日.jpg` | 90 | +2 | 0 | **92** | 主相簿，有組織的深層目錄 |
| `C:\Users\clove\OneDrive\圖片\2024\照片.jpg` | 90 | +1 | 0 | **91** | 主相簿，1 層子目錄 |
| `C:\Users\clove\OneDrive\圖片\照片.jpg` | 90 | 0 | 0 | **90** | 主相簿根目錄 |
| `C:\Users\clove\OneDrive\圖片\2024\照片(1).jpg` | 90 | +1 | -10 | **81** | 重複下載檔案 |
