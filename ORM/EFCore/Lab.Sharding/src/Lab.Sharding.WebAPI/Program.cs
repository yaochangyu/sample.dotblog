...
try
{
	...
	builder.Services.AddScoped<IDynamicDbContextFactory<MemberDbContext>, DynamicDbContextFactory<MemberDbContext>>();
	builder.Services.AddSingleton<IConnectionStringProvider, ConnectionStringProvider>(p =>
	{
		...
		connectionStringProvider.SetConnectionStrings(new Dictionary<string, string>
		{
			{
				"DatabaseA",
				"Server=localhost;Database=Member01;User Id=SA;Password=pass@w0rd1~;TrustServerCertificate=True"
			},
			{
				"DatabaseB",
				"Server=localhost;Database=Member02;User Id=SA;Password=pass@w0rd1~;TrustServerCertificate=True"
			}
		});
