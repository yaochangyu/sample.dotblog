...
namespace System.Data.SQLite.EF6.Migrations
{
    internal static class TypeUsageHelper
    {
        public static bool GetIsFixedLength(this TypeUsage tu, bool defaultValue = false)
        {
            ...
            return tu.Facets[DbProviderManifest.FixedLengthFacetName].Value == null
                       ? defaultValue
                       : (bool) tu.Facets[DbProviderManifest.FixedLengthFacetName].Value;
        }
        ...
        {
            return tu.Facets[DbProviderManifest.NullableFacetName].Value != null &&
                   (bool) tu.Facets[DbProviderManifest.NullableFacetName].Value;
        }

        public static bool GetIsUnicode(this TypeUsage tu)
        {
            return tu.Facets[DbProviderManifest.UnicodeFacetName].Value == null ||
                   (bool) tu.Facets[DbProviderManifest.UnicodeFacetName].Value;
        }

        public static int GetMaxLength(this TypeUsage tu, int defaultValue = int.MaxValue)
        {
            return tu.Facets[DbProviderManifest.MaxLengthFacetName].IsUnbounded ||
                   tu.Facets[DbProviderManifest.MaxLengthFacetName].Value == null
                       ? defaultValue
                       : (int) tu.Facets[DbProviderManifest.MaxLengthFacetName].Value;
        }

        public static byte GetPrecision(this TypeUsage tu, byte defaultValue = 18)
        {
            return tu.Facets[DbProviderManifest.PrecisionFacetName] == null
                       ? defaultValue
                       : (byte) tu.Facets[DbProviderManifest.PrecisionFacetName].Value;
        }
        ...
        {
            return tu.Facets[DbProviderManifest.ScaleFacetName] == null
                       ? defaultValue
                       : (byte) tu.Facets[DbProviderManifest.ScaleFacetName].Value;
        }
